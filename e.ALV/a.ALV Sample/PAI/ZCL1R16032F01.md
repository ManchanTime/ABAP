...
*-- Display ALV
    ...
    CALL METHOD go_alv_grid->set_table_for_first_display
      EXPORTING
        i_structure_name = 'SCARR'    " Structure name 줘야 함!!!!!!!
      ...
      CHANGING
        it_outtab        = gt_scarr   " 데이터를 담아줄 테이블
        it_fieldcatalog  = gt_fcat.   " ALV에 출력하고자 하는 ITAB의 필드정보 세팅
...
*&---------------------------------------------------------------------*
FORM make_body .
*-- 1. ITAB에 Country(10) 필드 추가
*-- 2. currcode가 'EUR'이면 country = 'Europe'
*--              'USD'이면 country = 'America'
*-- 3. 맨 마지막!.
