...
CLASS lcl_event_handler DEFINITION FINAL.
  ...
  PUBLIC SECTION.
    CLASS-METHODS : modify_value FOR EVENT data_changed_finished    " DATA_CHANGED_FINISHED 이벤트 선언부
                                 OF cl_gui_alv_grid
...
CLASS lcl_event_handler IMPLEMENTATION.
  ...
  METHOD edit_toolbar. " edit_toolbar 메서드 구현부
    PERFORM handle_edit_toolbar USING e_interactive e_object.    " edit_toolbar 컨트롤 Subroutine
  ENDMETHOD.
